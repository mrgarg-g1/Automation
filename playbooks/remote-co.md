...
2. Fully remote / "anywhere" is OK. **Hybrid** listings are OK only for Gurugram, Noida, or Delhi. Skip US hybrid (e.g. Texas/Arizona/Florida office days) and other non-NCR hybrid.
3. Skip listings marked as "anywhere in the world **with restrictions**" if restrictions exclude `profile.location.country`.
